...
CREATE TABLE users(
ma_user INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
userName NVARCHAR(250) NOT NULL,
userPassword VARCHAR(250) NOT NULL,
permission INT(2) UNSIGNED NOT null 
)
INSERT INTO users (userName, userPassword, permission) VALUES ('admin', 'admin', 0);
...
insert into theloai (ma_tloai,ten_tloai) VALUES (3,'Phoeniconaias minor');

insert into theloai (ten_tloai) VALUES ('Phoeniconaias minor');
